<template>
  ...
  <div id="center">
        <div class="wrapper">
            ...
            <div class="text">
                <div class="text--backing">VICTORT</div>
                <div class="text--left">
                    <div class="inner">VICTORT</div>
                </div>
    ...
    <div class="talk-method">
        <i class="iconfont icon-weixin"> : 1666541023</i>
        <i class="iconfont icon-qq"> : 1666541023 </i>
    </div>
</div>
</template>
<script>
    ...
    data () {
      return {
        ...
        navgation: [
            ...
            { name:' Github',icon:'iconfont icon-GitHub', path:'https://github.com/txluck' },
        ]
      };
    },
    methods: {
        //主页点击跳转函数
        triggerPage(path) {
            if(path === 'https://github.com/txluck') {
                window.open(path)
            } else {
                //利用路由跳转点击的某一个
...
@import url('./lizi/trigger.css');//引入css 实现中间字母动态效果
#center {
   display: flex;
